...
namespace analysis {
   namespace tools {
      ...
      class Analysis {
         public:
           ...
           ~Analysis();
            ...
            template<class Object>
            std::shared_ptr< PhysicsObjectTree<Object> > addTriggerTree(const std::string & unique_name, const std::string & path );
            template<class Object>
     ...
     template <> triggerTree    Analysis::addTriggerTree(const std::string & unique_name, const std::string & path);
